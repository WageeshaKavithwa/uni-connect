...
import { createPost, deletePost, getPostsByUser } from "../services/post-api";
...
export default function MyPosts() {
    ...
    const handleGetMyPosts = async () => {
        try {
            setLoading(true);
            setError(null);
            const response = await getPostsByUser(Number(sessionStorage.getItem('userId')), token);
    ...
    const handleDeletePost = async (postId: number) => {
        ...
        try {
            await deletePost(postId, Number(sessionStorage.getItem('userId')), token);
                    ...
                    <div key={post.id} className="postsCard">
                        <div className="postTopRow">
                            <div>
                             ...
                             <button type="button" onClick={() => handleDeletePost(post.id)} className="deleteBtn">
                                Delete Post
                            </button>
                        </div>
